...
มีการทดสอบระบบทั้งหมด **20 Test Case** ครอบคลุมการทำงานของผู้ใช้งานทุกประเภท ได้แก่ Customer, Staff และ Admin
...
| UAT-C04 | Customer | ดูรายละเอียดสินค้า | ✅ ผ่าน |
| UAT-C05 | Customer | เพิ่มสินค้าลงตะกร้า | ✅ ผ่าน |
| UAT-C06 | Customer | สั่งซื้อสินค้า | ✅ ผ่าน |
| UAT-C07 | Customer | อัปโหลดหลักฐานการชำระเงิน | ✅ ผ่าน |
| UAT-C08 | Customer | ตรวจสอบประวัติการสั่งซื้อ | ✅ ผ่าน |
| UAT-S01 | Staff | เข้าสู่ระบบ | ✅ ผ่าน |
| UAT-S02 | Staff | ตรวจสอบคำสั่งซื้อ | ✅ ผ่าน |
| UAT-S03 | Staff | แก้ไขข้อมูลสินค้า | ❌ ไม่ผ่าน |
| UAT-S04 | Staff | อัปเดตสถานะคำสั่งซื้อ | ✅ ผ่าน |
| UAT-S05 | Staff | ตรวจสอบการชำระเงิน | ✅ ผ่าน |
| UAT-A01 | Admin | จัดการสมาชิก | ✅ ผ่าน |
| UAT-A02 | Admin | แก้ไขข้อมูลสินค้า | ❌ ไม่ผ่าน |
| UAT-A03 | Admin | เพิ่มสินค้า | ✅ ผ่าน |
| UAT-A04 | Admin | ลบสินค้า | ✅ ผ่าน |
| UAT-A05 | Admin | จัดการประเภทสินค้า | ✅ ผ่าน |
| UAT-A06 | Admin | ดูรายงานระบบ | ✅ ผ่าน |
| UAT-A07 | Admin | จัดการคำสั่งซื้อ | ✅ ผ่าน |

### ผลการทดสอบ

| รายการ | จำนวน |
|--------|------:|
| Test Case ทั้งหมด | 20 |
| ผ่านการทดสอบ | 18 |
| ไม่ผ่านการทดสอบ | 2 |
| อัตราการผ่าน | 90% |

### อัตราผ่านการทดสอบ
จากการทดสอบ User Acceptance Testing (UAT) จำนวน 20 Test Case พบว่า ผ่านการทดสอบ 18 Test Case คิดเป็น 90% และ ไม่ผ่านการทดสอบ 2 Test Case คิดเป็น 10% โดย Test Case ที่ไม่ผ่านเกี่ยวข้องกับการจัดการข้อมูลสินค้าของ staff และ admin ซึ่งควรได้รับการปรับปรุงก่อนนำระบบไปใช้งานจริง

### สรุปผลการประเมิน UAT:
จากการทดสอบ User Acceptance Testing (UAT) จำนวน 20 Test Case พบว่า ผ่านการทดสอบ 18 รายการ และ ไม่ผ่านการทดสอบ 2 รายการ โดยภาพรวมระบบสามารถทำงานได้ตามความต้องการของผู้ใช้งานในฟังก์ชันหลัก เช่น การเข้าสู่ระบบ การจัดการคำสั่งซื้อ และการแสดงข้อมูลสินค้า อย่างไรก็ตาม ยังพบข้อบกพร่องในส่วนของการจัดการข้อมูลสินค้า ซึ่งทำให้ระบบยังไม่สามารถตอบสนองความต้องการของผู้ใช้งานได้อย่างครบถ้วน จึงควรดำเนินการแก้ไข Issue ที่พบทั้งหมดก่อนการส่งมอบหรือเผยแพร่ระบบให้ใช้งานจริง
---
